#ifndef _SVR_GENERAL_CLIENT_H_
#define _SVR_GENERAL_CLIENT_H_

#include "crc_easy_select_client.h"
#include <queue>

class GeneralClient : public CRCEasySelectClient
{
public:
	GeneralClient();
	...
	int  SendTest(CRCEqptMove* mmove, bool bChekSendBack);
	...
	void PushMessage(SOCKET srcSock, CRCDataHeader* header);
