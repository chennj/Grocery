...
bool CJsonObject::Add(const std::string& strKey, time_t llValue){
    return Add(strKey, static_cast<int64>(llValue));
}

bool CJsonObject::Get(const std::string& strKey, time_t& llValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
