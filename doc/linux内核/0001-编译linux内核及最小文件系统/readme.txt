...
这样一个完整的最小linux系统就起来啦： 作者：简说linux https://www.bilibili.com/read/cv11271232 出处：bilibili
...
错误及解决办法
----------------------
如果执行make menuconfig 产生fatal error: curses.h: 没有那个文件或目录的问题。 原因： 解决： sudo apt-get install libncurses5-dev 安装后再编译即可。
/////////////////////////////////////////////////////////////////////////////////////////////////////////////